package com.lambdaschool.medcabinet.logging;
...
{
    @Around(value = "@within(com.lambdaschool.medcabinet.logging.Loggable) || @annotation(com.lambdaschool.medcabinet.logging.Loggable)")
